...
const NotesSection = ({ notes, onSave }) => {
  ...
  return (
    <div className="student-affairs-section notes-section">
      <div className="section-header">
...
const VisitHistorySection = ({ visits = [], onSave }) => {
  ...
  return (
    <div className="student-affairs-section visit-history-section">
      <div className="section-header">
...
const DentalHistorySection = ({ dentalHistory = [], onSave }) => {
  ...
  return (
    <div className="student-affairs-section dental-history-section">
      <div className="section-header">
